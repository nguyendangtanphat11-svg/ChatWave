...
const LoginPage = () => {
    ...
    const onSubmit = async (e) => {
        ...
        try {
            ...
            setUser(data.user);
            navigate('/'); // Điều hướng tới trang Dashboard sau khi đăng nhập thường thành công
        } catch (err) {
    ...
    const handleGoogleSuccess = useCallback(async (credentialResponse) => {
        try {
            ...
            navigate("/"); // Điều hướng tới trang Dashboard sau khi đăng nhập Google thành công
        } catch (err) {
            setError(
