...
const MicOffIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="1" y1="1" x2="23" y2="23" /><path d="M9 9v3a3 3 0 0 0 5.12 2.12M15 9.34V4a3 3 0 0 0-5.94-.6" /><path d="M17 16.95A7 7 0 0 1 5 12v-2m14 0v2" /><line x1="12" y1="19" x2="12" y2="23" /></svg>;
...
const WelcomeScreen = ({ onStart, initialPreferences = {} }) => {
    ...
    const getMedia = async () => {
        ...
        try {
            const mediaStream = await Promise.resolve().then(() => navigator.mediaDevices.getUserMedia({ video: true, audio: true }));
            ...
            <div className="welcome-card fade-in-up">
                ...
                <div className="welcome-status-row">
                    ...
                    <div className={`welcome-status-card ${isMicOn ? 'on' : 'off'}`}>
                        <span className="status-icon">{isMicOn ? '🟢' : <MicOffIcon />}</span>
                        <div className="status-text">
