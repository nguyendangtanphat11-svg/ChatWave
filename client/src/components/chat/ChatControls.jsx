...
// Import icons or define them here
...
const ChatControls = ({ onMicToggle, onCameraToggle, onSkip, onEndCall, isMuted, isCameraOff, callState }) => {
    const navigate = useNavigate();

    return (
        <div className="chat-main-controls">
            <button className="chat-control-btn home" onClick={() => navigate('/')} title="Về trang chủ">
                <HomeIcon />
            </button>
            <>
    <button
